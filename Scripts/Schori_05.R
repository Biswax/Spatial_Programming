...
# Calculating average NDVI for each nafa
...
for(i in 1:nrow(NDVI)) {
  lines(dates$date, NDVI[i, ], col = "grey", type = "l", lwd = 2)}

lines(dates$date, NDVI[which.min(apply(NDVI, 1, min)),], col = "red", type = "l", lwd = 2)
